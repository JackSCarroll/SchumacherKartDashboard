...
class LocationEditorProvider with ChangeNotifier {
    LocationData _locationData = LocationData(uid: '', name: '', zoom: 0, latLng: const LatLng(0, 0));
    ...
    void setLocationData(String uid, String name, LatLng latLng, double zoom) {
        _locationData = LocationData(uid: uid, name: name, latLng: latLng, zoom: zoom);
        notifyListeners();
    }
}